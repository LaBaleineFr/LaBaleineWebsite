<template>
  <article class="flex w-100 w-70-m center-m w-40-l pa2 mb4 overflow-hidden bg-white br3 ba b--black-10">
    <img :src="member.image" class="br-100 h4 w4 dib ba b--black-05 mr3 self-center" :title="member.name">
